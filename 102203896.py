...
API_KEY = 'AIzaSyBliP-LbFtB9G7rIO1fpLHm15y9sxslXWQ'
CSE_ID = 'd0ebd54e3c6bd4abd'
...
def generate_mashup():
    ...
    return jsonify({"message": f"Images fetched. The file will be sent to {recipient_email} when ready."})
